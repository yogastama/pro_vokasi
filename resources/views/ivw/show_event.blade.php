...
<div class="container">
    <div class="kiri">
        ...
        <br>
        <div class="mt-2">
            <i class="fa-solid fa-calendar"></i> Registration Date
        </div>
        <small class="text-muted">
    ...
    <div class="kanan">
        ...
        <iframe width="100%" height="315" src="https://www.youtube.com/embed/{{ $event->youtube_video }}?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        @else
